...
using ASP_MVC.Areas.Identity.Models.User;
using ASP_MVC.Data;
...
namespace ASP_MVC.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, MasterDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
