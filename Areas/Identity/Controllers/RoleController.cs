...
using ASP_MVC.Areas.Identity.Models.Role;
using ASP_MVC.Data;
...
namespace ASP_MVC.Areas.Identity.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, MasterDbContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
